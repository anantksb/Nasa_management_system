					...
					{	
							...
							while($row = $result->fetch_array(MYSQLI_ASSOC))
							{
								...
								echo<<<abc
									...
									<td>
									<div class="info">User Name or ID: $a<br/>Full Name: $b $c</br>Date of Birth: $d<br/>Blood Group: $e<br/>Phone Numer: $f<br/>Email-ID: $g<br/>Address: $h<br/>Deptno: $i<br/>Date of Joining: $j<br/>Mission Working: $k(Currently working Mission)<br/>Designation: $l<br/>Salary: $m<br/><a href="Update Scientist.php?Usernameorid=$a">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Delete Scientist.php?Usernameorid=$a">Delete</a></div>
									</td>
									</tr>		 
									</table> 
abc;
